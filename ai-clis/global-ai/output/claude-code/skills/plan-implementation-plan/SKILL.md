---
name: plan-implementation-plan
description: Design and format an implementation plan to be used by another agent/person for implementation. Use whenever you want to plan out a body of work
---
...
Use this skill when you want to plan and format an implementation plan to be used by another agent. This skill explains what to look for as well as the final format needed for creating an implementation plan. 
...
Research the description given of what we are to implement. 

Search the following:

- Relevant codebases/code-snippets
- Documentation
- If needed, prompt the user for more information if you are unclear. Do not assume unless it is explicitly clear. 

Keep track of the following:

- What we will be implementing. 
- Why this is needed
- Is this meant to be a full complete feature? or will there more work to do after this. 

### Scope

Identify the scope needed for this body of work. Track the following: 

- What codebases will need to be changed?
- What components will need to be added? deleted? changed? 
...
### Implementation Phase 1: <Short 1-5 summary>

- GOAL-001: [Describe the goal of this phase, e.g., "Implement feature X", "Refactor module Y", etc.]

- [ ] **TASK-001**: Description of task 1
  - Sub bullet-points if needed to break down the work or be more descriptive
- [ ] **TASK-002**: Description of task 2
  - Sub bullet-points if needed to break down the work or be more descriptive
- [ ] **TASK-003**: Description of task 3
  - Sub bullet-points if needed to break down the work or be more descriptive

### Implementation Phase 2: <Short 1-5 summary>
