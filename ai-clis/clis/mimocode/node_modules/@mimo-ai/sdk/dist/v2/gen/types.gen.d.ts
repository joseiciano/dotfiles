...
export type EventSessionError = {
    ...
    properties: {
        sessionID?: string;
        error?: ProviderAuthError | UnknownError | MessageOutputLengthError | MessageAbortedError | StructuredOutputError | ContextOverflowError | InvalidOutputError | TextToolCallError | ContentFilterError | ModelError | ApiError;
    };
};
...
export type Part = TextPart | SubtaskPart | ReasoningPart | FilePart | ToolPart | StepStartPart | StepFinishPart | SnapshotPart | PatchPart | AgentPart | RetryPart | CheckpointPart | CompactionPart;
...
export type AgentConfig = {
    ...
    [key: string]: unknown | string | number | {
        ...
        [key: string]: unknown;
    } | string | "primary" | "secondary" | "accent" | "success" | "warning" | "error" | "info" | number | Array<string> | PermissionConfig | undefined;
};
...
export type McpStatus = McpStatusConnected | McpStatusDisabled | McpStatusPending | McpStatusFailed | McpStatusNeedsAuth | McpStatusNeedsClientRegistration;
export type Path = {
    home: string;
    state: string;
    config: string;
