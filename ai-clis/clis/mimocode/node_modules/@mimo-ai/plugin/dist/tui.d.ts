import type { AgentPart, OpencodeClient, Event, FilePart, LspStatus, McpStatus, Todo, SessionTaskResponse, Message, Part, Provider, PermissionRequest, QuestionRequest, SessionStatus, TextPart, Config as SdkConfig } from "@mimo-ai/sdk/v2";
...
export type TuiSidebarGoal = {
    condition?: string;
    verdicts: {
        [messageID: string]: TuiSidebarGoalVerdict;
    };
