import type { Event, createOpencodeClient, Project, Model, Provider, Permission, UserMessage, Message, Part, Auth, Config as SDKConfig } from "@mimo-ai/sdk";
 ...
 */
export declare const BUILT_IN_AGENTS: readonly ["main", "general", "build", "explore", "summary", "title", "checkpoint-writer", "dream", "distill", "compaction"];
...
export type ActorPreStopRegistration = ActorPreStopHook | {
    matcher?: ActorMatcher;
    run: ActorPreStopHook;
};
export type ActorPostStopRegistration = ActorPostStopHook | {
    matcher?: ActorMatcher;
    run: ActorPostStopHook;
};
/**
